...
namespace SolaceEditor.Utilities.Controls
{
    ...
    class NumberBox : Control
    {
        ...
        private void OnTextBlock_Mouse_LBD(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
        ...
        private void OnTextBlock_Mouse_LBU(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            if(_captured)
            {
                Mouse.Capture(null);
        ...
        private void OnTextBlock_Mouse_Move(object sender, System.Windows.Input.MouseEventArgs e)
        {
            if (_captured)
            {
